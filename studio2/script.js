...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    // generate random pixels, multiple by 1400 to get px to place image

    var topPos = Math.random() * 1400 + "px";
    var horzPos = Math.random() * 1400 + "px";
    ...
    setInterval(function() {
        ...
        topPos = Math.random() * 1400 + "px";
        horzPos = Math.random() * 1400 + "px";
